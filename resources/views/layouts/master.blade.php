            ...
            <div class="sidebar-wrapper active">
                ...
                <div class="sidebar-menu mt-4">
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item {{ request()->is('pesertadidik*') ? 'active' : '' }}">
                            <a href="{{ url('/pesertadidik') }}" class='sidebar-link'>
                        ...
                        <li class="sidebar-item">
                            <a href="{{ url('/prasarana') }}" class='sidebar-link'>
